...
const AccessDenied = () => {
  ...
  return (
    ...
    <Container maxWidth="sm" sx={{ 
      ...
      >
        You are trying to access public pages. Would you like to logout?
      </Typography>
      
      <Box sx={{ mt: 3, width: '100%', display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
